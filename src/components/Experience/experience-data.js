// src/components/Experience/experience-data.js
    ...
    projects: [
      {
        ...
        points: [
          ...
          'Handled 3rd-party API integrations and patch implementations.',
        ]
      },
      {
        title: 'HCLTech CEC',
    ...
    projects: [
      {
        ...
        cover: '/images/hcltech.jpeg',
        points: [
          'Gained experience in MVC & OOP in PHP.',
          'Developed custom Drupal modules.',
          'Contributed to Drupal.org.',
        ]
      },
      {
        ...
        cover: '/images/hcltech.jpeg',
        points: [
          'Learned HTML, CSS, Twig templating.',
          'Explored Git and GitHub workflows.',
        ]
      }
    ]
  }
